...
class Settings(QWidget):
    ...
    def _settings_init(self):
        ...
        self.setting_scan_dir_lineedit = QLineEdit(readOnly=True,text=r'C:\Users')
        self.setting_scan_dir_button = QPushButton('scan')
        self.setting_scan_dir_button.clicked.connect(lambda _:self.setting_scan_dir_lineedit.setText(
